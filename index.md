...
| ------------- | ------------- | ------------ 		|------------ |
| 30.10.19		| Lexical semantics		| Partee (1995); Johnson (2008) 	|			  |
| ------------- | ------------- | ------------ 		|------------ |
...
| ------------- | ------------- | ------------ 		|------------ |
| 27.11.19		| Common Ground/Presuppositions	| Stalnaker (2002);Clark & Marshall (1981)|	    |
| ------------- | ------------- | ------------ 		|------------ |
| 4.12.19		| Common Ground/Questions|  Farkas & Bruce (2010)	|	   |   
| ------------- | ------------- | ------------ 		|------------ |
